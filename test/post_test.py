...
def test_conflictDetection():
    ...
    policy = {"province":"北京","org":"李四","name":"张三","context":"为贯彻党的十八届三中、四中、五中全会精神和国家经济和社会发展“十三五”规划纲要提出的“创新、绿色、开放、共享、协调”发展理念，积极采用“云计算”、“大数据”、“物联网”和“移动互联网”等新技术，推动我省政府治理创新，加快实现政府治理现代化，根据《中共山东省委关于制定山东省国民经济和社会发展第十三个五年规划的建议》、《山东省人民政府办公厅关于贯彻国办发〔2014〕66号文件加快推进电子政务协调发展的实施意见》（鲁政办发〔2015〕59号），立足省情实际，制定本规划。 　　一、“十二五”电子政务发展回顾 　　（一）“十二五”电子政务发展现状 　　1.由注重基础设施建设转向业务应用为主阶段"}

    data = {"test_policy":"电子政务发展回顾","policy":json.dumps(policy)}
    r = requests.post(url, data=data, headers=headers)
