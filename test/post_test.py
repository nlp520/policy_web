...
def test_dataAnalyze():
    url = 'http://127.0.0.1:5000/dataAnalyze'
    # 请求头
    headers = {'content-type': 'application/x-www-form-urlencoded'}
    # 请求的参数
    data = {
...
def test_conflictDetection():
    url = 'http://127.0.0.1:5000/conflictDetection'
    # 请求头
    headers = {'content-type': 'application/x-www-form-urlencoded'}
    dic = {
...
def test_assoSingleAnalyze():
    url = 'http://127.0.0.1:5000/assoSingleAnalyze'
    # 请求头
    headers = {'content-type': 'application/x-www-form-urlencoded'}
    # 请求的参数
    data = {
...
def test_policyFind():
    url = 'http://127.0.0.1:5000/policyFind'
    # 请求头
    headers = {'content-type': 'application/x-www-form-urlencoded'}
    # 请求的参数
    data = {
